...
namespace Battleship_Shared
{
    ...
    {
        public static void InitializeGrid(Player model)
        {
        ...
        public static bool PlaceShip(Player model, string location)
        {
            bool output = false;
        ...
        private static bool ValidateShipLocation(Player model, string row, int column)
        {
        ...
        private static bool ValidateGridLocation(Player model, string row, int column)
        {
